...
export class Input extends React.Component<InputProps> {
  ...
  handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const errorMessage = this.props.validate && e.target.value && this.props.validate(e.target.value);
    const value = this.props.format ? this.props.format(e.target.value) : e.target.value;
    this.setState({
      value,
      errorMessage,
    });
